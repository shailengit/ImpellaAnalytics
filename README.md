...
- **Survival Prediction** — RandomForest (AUC 0.52, limited utility)
- **MCS Escalation Prediction** — RandomForest (AUC 0.86)
- **RV Dysfunction Prediction** — Logistic Regression (AUC 0.92)
