...
## Corpus Check
- 57 files · ~77,566 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 738 nodes · 904 edges · 46 communities (39 shown, 7 thin omitted)
...
Cohesion: 0.09
Nodes (42): CLAUDE.md Project Instructions, Patient Cluster Profiles, Cardiometabolic (High-risk) Cluster, Cardiorenal (Moderate-risk) Cluster, Non-congested (Low-risk) Cluster, Clustering Report, CLUSTER_BG, CLUSTER_COLORS (+34 more)
...
Cohesion: 0.10
Nodes (22): dependencies, axios, d3, dotenv, express, @google/genai, lucide-react, ml-random-forest (+14 more)
...
## Knowledge Gaps
- **426 isolated node(s):** `name`, `description`, `requestFramePermissions`, `majorCapabilities`, `name` (+421 more)
...
- **Why does `dependencies` connect `Frontend Dependencies` to `Documentation and Cluster Profiles`, `Build Toolchain`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Confusion Matrices — survival` connect `Prediction Script` to `ML Training Pipeline`?**
