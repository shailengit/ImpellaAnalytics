...
## Corpus Check
- 36 files · ~79,011 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 802 nodes · 970 edges · 52 communities (45 shown, 7 thin omitted)
...
Cohesion: 0.10
Nodes (38): Patient Cluster Profiles, Cardiometabolic (High-risk) Cluster, Cardiorenal (Moderate-risk) Cluster, Non-congested (Low-risk) Cluster, Clustering Report, CLUSTER_BG, CLUSTER_COLORS, ClusteringPage() (+30 more)
...
Cohesion: 0.08
Nodes (34): age, weight_kg, build_targets(), engineer_features(), evaluate_model(), export_lr_json(), export_sklearn_joblib(), generate_report() (+26 more)
...
Cohesion: 0.07
Nodes (25): dependencies, axios, clsx, d3, dotenv, express, @google/genai, lucide-react (+17 more)
...
Cohesion: 0.19
Nodes (14): engineer_cluster_features(), engineer_risk_features(), load_cluster_model(), load_risk_models(), main(), predict_clusters_all(), predict_risk_all(), predict_all.py — Combined risk prediction + cluster assignment for Node.js integ (+6 more)

### Community 51 - "Community 51"
Cohesion: 0.23
Nodes (12): generate_coefficient_plot(), generate_pv_loop_scatter(), generate_shap_for_escalation(), main(), pv_loop_analysis.py — Focused PV Loop analysis for MCS Escalation  This script:, Scatter plot of Ees/Ea vs escalation with logistic fit., Generate SHAP values for the full escalation RandomForest model., Bar chart of PV-loop logistic regression coefficients. (+4 more)
...
- **Why does `dependencies` connect `Frontend Dependencies` to `Prediction Script`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documentation and Cluster Profiles` to `Frontend Dependencies`?**
