...
<ul>
    ...
    <li><strong>MCS Escalation model AUC:</strong> 0.86–0.95 (clinically useful)</li>
    <li><strong>RV Dysfunction model AUC:</strong> 0.91 (clinically useful)</li>
    <li><strong>Survival model AUC:</strong> ~0.54 (limited — for research use only)</li>
...
<table>
    ...
    <tbody>
        <tr><td>Survival</td><td>Hospital mortality</td><td>RandomForest</td><td>0.54</td><td>Not clinically useful</td></tr>
        <tr><td>MCS Escalation</td><td>ECMO / LVAD / transplant / arrest</td><td>RandomForest</td><td>0.86–0.95</td><td>Clinically useful</td></tr>
        <tr><td>RV Dysfunction</td><td>Composite RV failure criteria</td><td>LogisticRegression</td><td>0.91</td><td>Clinically useful</td></tr>
...
<div class="card">
    ...
    <ul>
        <li><strong>Survival model is unreliable:</strong> AUC ~0.54 is barely above random chance. Survival in this cohort is likely driven by factors not captured in pre/post implant RHC data — refractory arrhythmias, multi-organ failure trajectory, withdrawal of care decisions, or complications unrelated to hemodynamics. Do <strong>not</strong> use the mortality risk score for clinical decision-making until validated on a larger cohort.</li>
